...
class FileSys {
  ...
  private:
	...
	/*bool is_directory(const short blockNum);
	
	void attach(dirblock_t curDir, const short bNum, const char *name);
	*/
	bool is_directory(const short block_num);
	
	void link(dirblock_t curDir, const short bNum, const char *newName);
};
